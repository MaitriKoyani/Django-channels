...
SECRET_KEY = 'django-insecure-gwj2sq@4dcdh(m14pyp-2gpicf^z)#42t#6_j1*cax@@sh3dsx'
...
MIDDLEWARE = [
    ...
    'chat.middleware.custom_middleware.CustomTokenMiddleware',
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'chat.models.CustomTokenAuthentication',
    ],
