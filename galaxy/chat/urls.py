...
urlpatterns = [
    ...
    path('checkotp/',TemplateView.as_view(template_name="checkotp.html"), name="checkotp"),
    path('api/checkotp/', views.CheckOtpView.as_view(), name='checkotp'),
    ...
    path('addfriend/',TemplateView.as_view(template_name="addfriend.html"), name="addfriend"),
